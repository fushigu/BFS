...
#define SET_VISITED2LOC(v) do {visited2[(v) ulong_shift] |= (1ULL << ((v) ulong_mask));} while (0)
...
#define CLEAN_VISITED()  do {memset(visited,0,visited_size*sizeof(unsigned long));} while(0)
#define CLEAN_VISITED2() do {memset(visited2,0,visited_size*sizeof(unsigned long));} while(0)
